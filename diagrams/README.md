...
Then we stepped into details with the 2nd level of the C4 diagram (Container Diagram - Smoc George-Marian). This allowed us to separate the project into components and emphasize their relationships.
